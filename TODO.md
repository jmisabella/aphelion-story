# APHELION — Pre-Writing TODO

These items must be resolved before chapter writing begins. See STORY_PLAN.md for full context on each.

---

## 1. Characters
**Blocking — nothing can be written without this.**

- Protagonist: name, specific age, role/job aboard the ship. Her job determines how she plausibly encounters the suppressed information.
...
**Blocking — central to atmosphere; must be specific before writing.**

- Are they personalized (each person sees something different) or collective (shared visions)?
- What is the content — people who aren't there? Places? Memories? The void of space?
...
**Plot-driving — determines the shape of the protagonist's investigation.**

- Already partially covered in Characters above, but needs dedicated thought.
...
## 4. Narrative Arc / Scene Structure
**Shapes everything — should be locked before writing chapter 1.**

- How many chapters, roughly?
- What is the inciting incident that kicks the story into motion?
- What is the shape of the protagonist's discovery — gradual accumulation, or a single rupture?
...
## 5. Ship's Culture
**Can be developed in parallel with or just before writing chapter 1.**

- What do the people of the Aphelion *believe* about themselves and their mission?
- What myths or quasi-religion have grown up around the Architects over generations?
- What do they think their destination is, and how do they relate to it?
